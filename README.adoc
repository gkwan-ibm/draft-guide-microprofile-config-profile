...
The application that you will be working with is a `query` service. It communicates with the `system` service to fetch the system property information of your local JVM. 
