...
Before testing the application in the `testing` environment, you need to update the `microprofile-config.properties` file with new properties that were added in the previous section.
...
Add the `system.userPassword`, `system.properties`, `role`, and `query.*` properties.

Navigate to the `start` directory to test the application by running the following Maven goals:
...
------------------------------------------------------------------------
Total time:  3.324 s
Finished at: 2022-11-11T16:36:41-05:00
------------------------------------------------------------------------
----
