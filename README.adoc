...
:page-description: Learn how to use MicroProfile Config Profile to provide multiple configurations in development life cycle.
...
Learn how to use MicroProfile Config Profiles to provide multiple configurations for different phases in development life cycle.
