...
microprofile-config-development.properties
[source, properties, linenums, role="code_column hide_tags=contactEmail"]
----
include::finish/query/src/main/resources/META-INF/microprofile-config-development.properties[]
----
...
Explain different APIs, e.g [hotspot=config file=1]`Config`, [hotspot=configValue file=1]`ConfigValue`, ...
