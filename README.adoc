...
Annotate the [hotspot=ConfigSystemBean file=0]`ConfigSystemBean` class with the [hotspot=prefix file=0]`@ConfigProperties` annotation. The [hotspot=ConfigSystemBean file=0]`prefix` attribute specifies the common prefix of the configuration properties to `system`.
